...
public class CapacitorPedometerPlugin: CAPPlugin, CAPBridgedPlugin {
  ...
  public let pluginMethods: [CAPPluginMethod] = [
    CAPPluginMethod(name: "startCounting", returnType: CAPPluginReturnPromise),
    CAPPluginMethod(name: "stopCounting", returnType: CAPPluginReturnPromise),
    CAPPluginMethod(name: "getStepCount", returnType: CAPPluginReturnPromise),
  ]
    ...
    pedometer?.startUpdates(from: Date()) { [weak self] (pedometerData, error) in
      ...
      if let error = error {
        ...
        self.bridge?.triggerJSEvent(
          eventName: "stepCountError", target: "document",
      ...
      if let data = pedometerData {
        ...
        self.bridge?.triggerJSEvent(
          eventName: "stepCountChange", target: "document",
          data: "{ \"count\": \(self.currentStepCount) }")
      }
    }
    call.resolve()
  }
